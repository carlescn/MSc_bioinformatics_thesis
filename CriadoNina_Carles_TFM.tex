...
%        \usepackage{varioref}
        ...
        \usepackage[acronym,nomain,section=section,numberedsection=autolabel]{glossaries}
            ...
            \newacronym{dbn}{DBN}{\textit{deep beliefnetwork}}
...
\todo{
    ...
    \label{s:state_reduccio}
        ...
        Una limitació dels mètodes lineals és que no són capaços de retenir informació sobre relacions no lienals en les dades, el que provoca una reducció de la \gls{cq}. Les tècniques no lineals són més adequades \citep{Karim2021}.
    ...
    \label{s:state_deep}
        ...
        La majoria d'aproximacions actuals utilitzen una arquitectura basada en un \gls{ae} \citep{Karim2021}, donat que és capaç d'obtenir \gls{lf} eficients per realitzar \textit{clusering}.
