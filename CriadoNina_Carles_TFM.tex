...
\todo{
    \begin{itemize}
        \item Mencionar figures al text.
        \item Figura 3.3: buscar figura on es representin les funcions de cost.
    \end{itemize}
}
    ...
    \label{s:metodes_vae}
        ...
        \begin{figure}[htpb]
            \centering
            \includegraphics{kingma2019_vae.png}
            \caption{
    ...
    \label{s:vae_gradients}
        ...
        \begin{figure}[htpb]
            \centering
            \includegraphics{kingma2019_reparam_trick.png}
            \caption{
    ...
    \label{s:vae_implementacio}
        ...
        \begin{figure}[htpb]
            \centering
            \includegraphics{karim2021_vae.png}
            \caption{
                !!
                Esquema del model VAE.
                Buscar figura on es representin les funcions de cost.
                !!
